...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6 max-w-6x2">
        ...
        <a href="<?php echo e(route('bendahara.weekly.payments')); ?>" class="bg-white p-6 rounded-lg shadow <?php echo e(isset($isFriday) && $isFriday ? 'ring-4 ring-red-500 shadow-2xl animate-pulse border-4 border-red-400' : 'hover:shadow-md'); ?> transition-all block">
            ...
            <?php else: ?>
                <p class="text-gray-600">Selanjutnya: Jumat, <?php echo e($nextFriday); ?></p>
