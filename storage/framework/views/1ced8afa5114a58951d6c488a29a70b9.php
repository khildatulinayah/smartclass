    ...
    <nav class="bg-gray-900 pixel-border border-b-4 border-gray-900 mb-8">
        <div class="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <div class="flex items-center gap-4">
                <span class="pixel-font text-white text-xs">PLAYER: <?php echo e(strtoupper(auth()->user()->name)); ?></span>
...
</html><?php /**PATH C:\laragon\www\projectsc\resources\views/layouts/app.blade.php ENDPATH**/ ?>