    ...
    <div class="container">
        <div class="login-card">
            ...
            <div style="text-align: center; margin-top: 20px;">
                <a href="<?php echo e(url('/')); ?>" style="color: #0066ff; text-decoration: none; font-size: 10px; letter-spacing: 1px;">← HOME</a>
            </div>
        </div>
...
<?php /**PATH C:\laragon\www\projectsc\resources\views/login.blade.php ENDPATH**/ ?>