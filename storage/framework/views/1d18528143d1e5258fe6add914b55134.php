            ...
            <div class="mb-6 p-4 border-4 border-black bg-gray-50">
                ...
                <div class="grid grid-cols-4 gap-2">
                    <?php for($week = 1; $week <= 4; $week++): ?>
                        ...
                        ?>
                        <div class="text-center p-2 <?php echo e($isPaid ? 'bg-green-100 border-green-400' : 'bg-red-100 border-red-400'); ?> border-2">
                            <div class="pixel-font text-xs">Minggu <?php echo e($week); ?></div>
                            <div class="pixel-font text-xs text-gray-600"><?php echo e($wednesdayDates[$week]); ?></div>
                    ...
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p class="pixel-font text-xs text-gray-600">
                                Menunggak <?php echo e($unpaidPayments->count()); ?> minggu: 
