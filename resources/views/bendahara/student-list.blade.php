...
<div class="max-w-6xl mx-auto mt-6">
    <a href="{{ route('bendahara.dashboard') }}" class="pixel-card p-4 bg-gray-200 hover:bg-gray-300 text-center block">
    ...
    container.innerHTML = filteredStudents.map(student => `
        <div class="flex items-center justify-between p-3 bg-gray-50 rounded hover:bg-gray-100 transition-colors cursor-pointer">
            ...
            <div class="flex items-center space-x-2">
                <a href="/bendahara/kas" 
                   class="pixel-card px-3 py-1 bg-indigo-500 text-white text-xs hover:bg-indigo-600 transition-colors">
                    💳 Kas
                </a>
            </div>
        </div>
