...
<div class="max-w-6xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
        <a href="{{ route('admin.students') }}" class="pixel-card p-6 bg-white hover:bg-blue-50 transition-colors block">
            <h2 class="pixel-font text-sm mb-2 text-blue-700">👥 MANAJEMEN SISWA</h2>
            <p class="text-gray-600 text-xs">Kelola data siswa aktif</p>
        </a>
        
        <a href="{{ route('admin.reports') }}" class="pixel-card p-6 bg-white hover:bg-green-50 transition-colors block">
